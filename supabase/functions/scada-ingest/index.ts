...
const SENSORS: Sensor[] = [
  ...
  { id: "WTP-Totalizer-IN", mqttKey: "TOTALIZER_IN", label: "Totalizer (Inlet)", unit: "m³", min: 0, max: 999999, section: "wtp", instrumentType: "totalizer" },
  { id: "WTP-Flow-OUT", mqttKey: "FLOW_OUT", label: "Flow Meter (Outlet)", unit: "m³/hr", min: 0, max: 200, section: "wtp", instrumentType: "flow" },
  { id: "WTP-Totalizer-OUT", mqttKey: "TOTALIZER_OUT", label: "Totalizer (Outlet)", unit: "m³", min: 0, max: 999999, section: "wtp", instrumentType: "totalizer" },
