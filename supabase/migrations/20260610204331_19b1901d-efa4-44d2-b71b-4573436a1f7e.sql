...
CREATE TABLE public.gis_config (
  ...
  intake_device_id text NOT NULL DEFAULT 'MOH_INTK_001',
  wtp_device_id text NOT NULL DEFAULT 'MOH_WTP_001',
  oht1_device_id text NOT NULL DEFAULT 'MOH_OHT_001',
  oht2_device_id text NOT NULL DEFAULT 'MOH_OHT_002',
  oht3_device_id text NOT NULL DEFAULT 'MOH_OHT_003',
